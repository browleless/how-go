          ...
          .then(res => {
            ...
            for (var k = 0; k < this.routes.length; k++) {
              ...
              for (var l = 0; l < this.routes[k].legs.length; l++) {
                ...
                var steps = {}
                // if (l === 0) {
                //   this.routes[k].legs[l].from.name = this.$store.getters.calendarEvents[i].name
                // }
                // if (l === this.routes[k].legs.length - 1) {
                //   this.routes[k].legs[l].to.name = this.$store.getters.calendarEvents[i + 1].name
                // }
